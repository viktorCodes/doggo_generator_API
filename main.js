...
.then(data => {
    ...
    for(let i =0; i < breedsArray.length; i++ ){
        ...
        const option = document.createElement('option') //create <option></option> element
...
const getDoggoImg = url => {
    ...
    .then(data => {
        img.src = data.message // extract message from JSON and attack to img tag as new source
    })
}
